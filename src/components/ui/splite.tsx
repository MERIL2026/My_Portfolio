...
export function SplineScene({ scene, className }: SplineSceneProps) {
  ...
  if (useFallback) {
    return (
      <div 
        ...
        className={`overflow-hidden select-none cursor-pointer ${className || 'relative w-full h-full'}`}
      >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-brand-gray/30 via-brand-dark/95 to-brand-black rounded-[50px] border-2 border-brand-white/10 shadow-2xl overflow-hidden flex items-center justify-center">
                ...
                >
                  ...
                  {/* DIGITAL LED MATRIX ROBOTIC EYES */}
                  <div 
                    style={{
  ...
  return (
    <Suspense 
      fallback={
        <div className="w-full h-full flex items-center justify-center bg-brand-dark/50 backdrop-blur-sm">
